...
import { InpaintParams } from "../../context/StepContext";

interface InpaintModalProps {
  onClose: () => void; // 모달 닫기 (아니요)
  onConfirm: (params: InpaintParams) => void; // 생성 시작 (예)
}
      ...
      >
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            />
            <SliderInput
              label="New Concept Images Weight"
              name="new_concept_images_weight"
              value={params.new_concept_images_weight}
              onChange={handleSliderChange}
            />
            <SliderInput
